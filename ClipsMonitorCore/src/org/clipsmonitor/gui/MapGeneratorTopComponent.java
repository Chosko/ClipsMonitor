...
public final class MapGeneratorTopComponent extends TopComponent {
    ...
    public MapGeneratorTopComponent() {
        ...
        PreviewMap.setSize(new Dimension((int)model.getPreferredWidth(),(int)model.getPreferredHeight()));
        PreviewMap.setPreferredSize(new Dimension((int)model.getPreferredWidth(),(int)model.getPreferredHeight()));
        directory = ProjectDirectory.getIstance(new File("./"));
        
        // initialize load and save buttons
    ...
    private void initComponents() {
        ...
        PreviewMap.setFocusable(false);
        PreviewMap.setRequestFocusEnabled(false);
        ...
        jScrollPane7.setViewportView(PreviewMap);
        ...
        jScrollPane7.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MapGeneratorTopComponent.class, "MapGeneratorTopComponent.jScrollPane7.AccessibleContext.accessibleDescription")); // NOI18N
  ...
  private void JsonCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JsonCreateActionPerformed
    ...
    */
    ...
    /**
     * Verifica e controlla se vi sono attualemente dei colori attualmente 
     * utilizzati 
     * 
     * @return 
     */
    ...
    /**
     * Abilita-disabilita gli elementi della GUI a seconda della modalità di uso
     * attualmente selezionata
     * 
     * @param Map 
     */

    private void setButtons(boolean Map){
    
        // condizioni valide in modalità map
        
        MapButton.setSelected(Map);
        MoveButton.setEnabled(Map);
        RefreshButton.setEnabled(Map);
        XButton.setEditable(Map);
        YButton.setEditable(Map);
        MaxDur.setEditable(Map);
        
        // condizioni valide in modalità move
        
        MapButton.setEnabled(!Map);
        MoveButton.setSelected(!Map);
        AddPathButton.setEnabled(!Map);
        AddPersonButton.setEnabled(!Map);
        DeletePersonButton.setEnabled(!Map);
        RemovePathButton.setEnabled(!Map);
        StepList.setEnabled(!Map);
        PersonPathList.setEnabled(!Map);
        PersonsList.setEnabled(!Map);
    }

    
    /**
     *  Verifica le condizioni di attivazione delle JList in base al loro contenuto
     */
    ...
    /**
     *  Rimuove l'agente attualmente selezionato
     */
    ...
    */
    ...
    /**
     * Esegue una richiesta di aggiunta di un nuovo percorso per l'agente attualmente
     * selezionato
     */
    ...
    /**
     *  Esegue una richiesta di rimozione di un percorso dell'agente selezionato
     **/
    ...
    */
    ...
    /**
     * Aggiorna il log da visualizzare sulla console Log
     */
